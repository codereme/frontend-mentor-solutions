...
A card component showcasing statistics. The key feature is a **color overlay on the main image**, created using an `::after` pseudo-element with a semi-transparent background.
